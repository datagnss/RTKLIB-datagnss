...
!WAIT 100\n \
#disable nmea\n \
!HEX F1 D9 06 01 03 00 F0 00 00 FA 0F F1 D9 06 01 03 00 F0 01 00 FB 11 F1 D9 06 01 03 00 F0 02 00 FC 13\n \
!HEX F1 D9 06 01 03 00 F0 03 00 FD 15 F1 D9 06 01 03 00 F0 04 00 FE 17 F1 D9 06 01 03 00 F0 05 00 FF 19\n \
!HEX F1 D9 06 01 03 00 F0 06 00 00 1B F1 D9 06 01 03 00 F0 07 00 01 1D F1 D9 06 01 03 00 F0 08 00 02 1F\n \
!HEX F1 D9 06 01 03 00 F0 20 00 1A 4F\n \
!WAIT 100\n \
...
#disable,MSM7\n \
#!HEX F1 D9 06 01 03 00 F8 4D 00 4F C1 F1 D9 06 01 03 00 F8 57 00 59 D5 F1 D9 06 01 03 00 F8 61 00 63 E9\n \
#!HEX F1 D9 06 01 03 00 F8 75 00 77 11 F1 D9 06 01 03 00 F8 7F 00 81 25\n \
!WAIT 100\n \
#disable MSM4\n \
!HEX F1 D9 06 01 03 00 F8 4A 00 4C BB F1 D9 06 01 03 00 F8 54 00 56 CF F1 D9 06 01 03 00 F8 58 00 5A DF\n \
!HEX F1 D9 06 01 03 00 F8 72 00 74 0B F1 D9 06 01 03 00 F8 7C 00 7E 1F\n \
!WAIT 100\n \
#enable eph\n \
!HEX F1 D9 06 01 03 00 F8 13 05 1A 52 F1 D9 06 01 03 00 F8 14 05 1B 54 F1 D9 06 01 03 00 F8 2A 05 31 80\n \
!HEX F1 D9 06 01 03 00 F8 2C 05 33 84 F1 D9 06 01 03 00 F8 2D 05 34 86\n \
#enable MSM7\n \
!HEX F1 D9 06 01 03 00 F8 4D 01 50 C2 F1 D9 06 01 03 00 F8 57 01 5A D6 F1 D9 06 01 03 00 F8 61 01 64 EA\n \
!HEX F1 D9 06 01 03 00 F8 75 01 78 12 F1 D9 06 01 03 00 F8 7F 01 82 26\n \
#enable MSM4\n \
#!HEX F1 D9 06 01 03 00 F8 4A 01 4D BC F1 D9 06 01 03 00 F8 54 01 57 D0 F1 D9 06 01 03 00 F8 58 01 5B D8\n \
#!HEX F1 D9 06 01 03 00 F8 72 01 75 0C F1 D9 06 01 03 00 F8 7C 01 7F 20\n \
!WAIT 500\n \
#10hz output\n \
