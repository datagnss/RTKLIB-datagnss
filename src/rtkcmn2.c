...
const prcopt_t prcopt_default2={ /* defaults processing options */
    PMODE_KINEMA,0,2,SYS_GPS|SYS_CMP|SYS_GLO|SYS_GAL,   /* mode,soltype,nf,navsys */
    15.0*D2R,{{0,0}},           /* elmin,snrmask */
